      ...
      <section className={styles.content}>
        <div className={styles.contentGrid}>
          ...
          <div className={styles.blocks}>
            <article className={styles.block}><h2>Productos corporativos</h2><p>Desarrollamos piezas que ayudan a presentar, identificar o acompañar a equipos, clientes y eventos.</p><ul><li>Textiles y dotaciones personalizadas</li><li>Promocionales y artículos de marca</li><li><Link href="/servicios/material-pop">Materiales para campañas y eventos</Link></li></ul></article>
            ...
            <article className={styles.block}><h3>Proyectos a medida</h3><p>También conectamos varias capacidades de DIXOY cuando un producto termina siendo parte de una solución mayor.</p><ul><li><Link href="/servicios/diseno-de-marca">Diseño + producción</Link></li><li>Producto + instalación</li><li>Marca + espacio + tecnología</li></ul></article>
          </div>
        </div>
      </section>
      <section className={styles.band}><div><h2>Si puedes explicarnos la necesidad, podemos empezar a construir la solución.</h2><p>No todo tiene que existir previamente en un catálogo.</p></div><Link href="/servicios">Explorar servicios relacionados</Link></section>
