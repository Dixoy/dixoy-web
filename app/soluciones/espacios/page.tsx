...
export default function SpacesSolutionPage() {
  return (
    <main className={styles.page}>
      ...
      <section className={styles.content}>
        <div className={styles.contentGrid}>
          ...
          <div className={styles.blocks}>
            <article className={styles.block}><h2>Adecuaciones</h2><p>Mejoramos espacios comerciales y corporativos para responder mejor al uso diario.</p><ul><li><Link href="/servicios/adecuacion-de-espacios">Adecuación de espacios</Link></li><li>Divisiones y elementos funcionales</li><li>Integración de acabados e instalaciones</li></ul></article>
            <article className={styles.block}><h3>Exhibición y ambientación</h3><p>Diseñamos y producimos elementos que ayudan a presentar productos, orientar personas y reforzar la identidad del lugar.</p><ul><li>Mobiliario y exhibidores</li><li>Ambientación de puntos de venta</li><li><Link href="/servicios/avisos-y-senalizacion">Gráfica aplicada y señalización</Link></li></ul></article>
      ...
      <section className={styles.band}><div><h2>El espacio también comunica cómo trabaja tu empresa.</h2><p>Diseñamos la solución pensando en uso, imagen y ejecución.</p></div><Link href="/servicios">Explorar servicios para espacios</Link></section>
