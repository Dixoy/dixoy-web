      ...
      <section className={styles.content}>
        <div className={styles.contentGrid}>
          ...
          <div className={styles.blocks}>
            ...
            <article className={styles.block}><h3>Seguridad y control</h3><p>Implementamos soluciones para proteger espacios y administrar accesos.</p><ul><li>Control de acceso</li><li>Cámaras y seguridad</li><li>Integración de dispositivos y sistemas</li></ul></article>
            <article className={styles.block}><h3>Soluciones digitales</h3><p>Conectamos herramientas que ayudan a organizar procesos, información y atención al cliente.</p><ul><li>Desarrollo y presencia web</li><li>Automatización y herramientas digitales</li><li>DixApp y soluciones empresariales propias</li></ul></article>
          </div>
        </div>
      </section>
      <section className={styles.band}><div><h2>La tecnología debe resolver, no complicar.</h2><p>Partimos del proceso y luego elegimos la herramienta.</p></div><Link href="/soluciones">Ver todas las soluciones</Link></section>
