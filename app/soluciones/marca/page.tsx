      ...
      <section className={styles.content}>
        <div className={styles.contentGrid}>
          ...
          <div className={styles.blocks}>
            <article className={styles.block}><h2>Identidad y diseño</h2><p>Creamos o fortalecemos la forma en que una empresa se presenta visualmente.</p><ul><li><Link href="/servicios/diseno-de-marca">Diseño de marca e identidad visual</Link></li><li>Piezas corporativas y comerciales</li><li>Adaptación de identidad a diferentes medios</li></ul></article>
            <article className={styles.block}><h3>Impresión y producción visual</h3><p>Llevamos el diseño a materiales reales, desde piezas pequeñas hasta formatos de gran escala.</p><ul><li><Link href="/servicios/impresion-gran-formato">Impresión comercial y gran formato</Link></li><li>Vinilos, pendones y elementos gráficos</li><li><Link href="/servicios/material-pop">Material POP y promocional</Link></li></ul></article>
            <article className={styles.block}><h3>Avisos y señalización</h3><p>Desarrollamos elementos para identificar, orientar y hacer visible una empresa o espacio.</p><ul><li><Link href="/servicios/avisos-y-senalizacion">Avisos corporativos y señalización</Link></li><li>Señalización interior y exterior</li><li>Gráfica para puntos de venta y oficinas</li></ul></article>
          </div>
        </div>
      </section>
      <section className={styles.band}><div><h2>Una marca no termina en el logo.</h2><p>La hacemos coherente desde la idea hasta su aplicación física.</p></div><Link href="/servicios">Explorar servicios de marca</Link></section>
