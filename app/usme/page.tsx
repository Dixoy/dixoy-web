...
export const metadata: Metadata = {
  ...
  description:
    "Diseño, impresión, avisos, adecuación de espacios, tecnología y soluciones personalizadas para empresas, comercios y emprendedores en Usme, Bogotá.",
  alternates: { canonical: "/usme" },
  openGraph: {
    title: "DIXOY en Usme | Soluciones para empresas y negocios",
    description:
      "Diseño, producción, espacios, tecnología y soluciones personalizadas para empresas y negocios en Usme.",
    images: ["/og-dixoy.png"],
    locale: "es_CO",
    siteName: "DIXOY",
    type: "website",
